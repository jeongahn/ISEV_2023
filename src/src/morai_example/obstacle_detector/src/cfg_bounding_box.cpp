...
void ParamCallback(obstacle_detector::hyper_parameterConfig &config, int32_t level) {
...
int main(int argc, char **argv) {
  ros::init(argc, argv, "cfg_bounding_box");
  ros::NodeHandle nh;

  dynamic_reconfigure::Server<obstacle_detector::hyper_parameterConfig> server;
  dynamic_reconfigure::Server<obstacle_detector::hyper_parameterConfig>::CallbackType f;
